...
public class PoolExample {
    public static void main(String[] args) throws InterruptedException {
        var executor = new ThreadPoolExecutor(3, 3, 1, TimeUnit.SECONDS, new LinkedBlockingQueue<>(3));
        ...
        var inProgress = new AtomicInteger(0);
        ...
        for (int i = 0; i < 30; i++) {
            ...
            executor.submit(() -> {
                var working = inProgress.incrementAndGet();
